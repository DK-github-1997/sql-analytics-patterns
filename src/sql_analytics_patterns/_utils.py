"""Internal utilities for sql_analytics_patterns."""
...
from .exceptions import SqlAnalyticsPatternsError
...
def retry(
    max_attempts: int = 3,
    delay: float = 1.0,
    exceptions: tuple[type[Exception], ...] = (SqlAnalyticsPatternsError,),
